...
const STR = {
  en: {
    ...
    ts_exceptionHint: "Tap a day to set it: ✓ available, – not available, blank follows your usual week. A dot means you set that date yourself.",
    ts_hoursSection: "Hours",
    ts_peopleSection: "People",
    ts_viewWeek: "Week",
    ts_viewMonth: "Month",
    ts_freeCount: "Free",
    ts_availLegend: "✓ available · – not available · · not answered. Blank days follow that person's usual week; nobody is counted as free unless they said so.",
  ...
  hi: {
    ...
    ts_exceptionHint: "दिन पर टैप करें: ✓ उपलब्ध, – अनुपलब्ध, खाली मतलब सामान्य सप्ताह। बिंदु का अर्थ है वह तारीख आपने खुद तय की।",
    ts_hoursSection: "घंटे",
    ts_peopleSection: "लोग",
    ts_viewWeek: "सप्ताह",
    ts_viewMonth: "महीना",
    ts_freeCount: "उपलब्ध",
    ts_availLegend: "✓ उपलब्ध · – अनुपलब्ध · · कोई जवाब नहीं। खाली दिन उस व्यक्ति के सामान्य सप्ताह से लिए जाते हैं; बिना कहे कोई उपलब्ध नहीं गिना जाता।",
    ts_available: "उपलब्ध",
