...
const STR = {
  en: {
    ...
    ts_thisMonth: "This month",
    ts_lastMonth: "Last month",
    ts_useNow: "Use current time",
    ...
    ts_usualWeekHint: "Tap the days you usually work. Tap again to undo. Days you booked off stay off.",
    ts_exceptionHint: "Tap a day: once ✓ can work, twice ✕ off, again to clear. Dashed = usual week, not confirmed.",
    ...
    rota_section: "Rota",
    rota_draft: "Draft",
    rota_published: "Published",
    rota_publish: "Publish rota",
    rota_unpublish: "Unpublish",
    rota_draftHint: "This month is a draft — only you can see it. Publish it when it's ready for staff.",
    rota_publishedHint: "Published — staff can now see their own shifts. Changes you make show up straight away.",
    rota_onCount: "On",
    rota_gridHint: "Tap a day to put someone on it; tap again to open times or take them off. ✓ scheduled · • has set times.",
    rota_timesHint: "Times are optional — leave both blank for a shift with no fixed hours yet.",
    rota_removeShift: "Remove",
    rota_bothTimes: "Enter both a start and an end time, or leave both blank.",
    rota_badTime: "Enter times as HH:MM.",
    rota_myShifts: "My shifts",
    rota_myShiftsHint: "Your published shifts for the weeks ahead. Times may be added closer to the day.",
    ...
    rota_currentMonthPdf: "Current month rota (PDF)",
    rota_nextMonthPdf: "Next month rota (PDF)",
    rota_noShifts: "No shifts scheduled for this month yet.",
  ...
  hi: {
    ...
    ts_thisMonth: "इस माह",
    ts_lastMonth: "पिछला माह",
    ts_useNow: "अभी का समय भरें",
    ...
    ts_usualWeekHint: "जिन दिनों आप आमतौर पर काम करते हैं टैप करें। दोबारा टैप से हटेगा। खुद लगाई छुट्टी वैसे ही रहेगी।",
    ts_exceptionHint: "दिन पर टैप करें: एक बार ✓ काम, दो बार ✕ छुट्टी, फिर से हटाने को। बिंदीदार = सामान्य सप्ताह, पक्का नहीं।",
    ...
    rota_section: "रोटा",
    rota_draft: "ड्राफ्ट",
    rota_published: "प्रकाशित",
    rota_publish: "रोटा प्रकाशित करें",
    rota_unpublish: "अप्रकाशित करें",
    rota_draftHint: "यह माह अभी ड्राफ्ट है — इसे सिर्फ आप देख सकते हैं। तैयार होने पर स्टाफ के लिए प्रकाशित करें।",
    rota_publishedHint: "प्रकाशित — अब स्टाफ अपनी शिफ्ट देख सकते हैं। आपके बदलाव तुरंत दिखते हैं।",
    rota_onCount: "ड्यूटी",
    rota_gridHint: "किसी दिन पर टैप करके ड्यूटी लगाएं; दोबारा टैप करने पर समय जोड़ें या हटाएं। ✓ ड्यूटी · • समय तय है।",
    rota_timesHint: "समय वैकल्पिक है — बिना तय घंटों वाली शिफ्ट के लिए दोनों खाली छोड़ें।",
    rota_removeShift: "हटाएं",
    rota_bothTimes: "शुरू और समाप्त दोनों समय डालें, या दोनों खाली छोड़ें।",
    rota_badTime: "समय HH:MM में डालें।",
    rota_myShifts: "मेरी शिफ्ट",
    rota_myShiftsHint: "आने वाले हफ्तों की आपकी प्रकाशित शिफ्ट। समय दिन के करीब जोड़ा जा सकता है।",
    ...
    rota_currentMonthPdf: "इस माह का रोटा (PDF)",
    rota_nextMonthPdf: "अगले माह का रोटा (PDF)",
    rota_noShifts: "इस माह के लिए अभी कोई शिफ्ट तय नहीं है।",
