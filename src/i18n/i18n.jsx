...
const STR = {
  en: {
    ...
    ts_usualWeekHint: "Tap the days you can normally work.",
    ts_next3Weeks: "Next 3 weeks",
    ts_exceptionHint: "Tap a day to change it just for that date. A dot means it differs from your usual week.",
    ...
    ts_setPin: "Set PIN",
    ts_clearPin: "Clear",
    ts_clearPinHint: "Remove the PIN — anyone can then pick this name.",
    ts_pinHint: "A PIN stops someone logging hours under another name. It is not a login: any staff device can still write to the timesheet, so review the month before you pay it.",
  ...
  hi: {
    ...
    ts_usualWeekHint: "जिन दिनों आप आमतौर पर काम कर सकते हैं उन्हें चुनें।",
    ts_next3Weeks: "अगले 3 सप्ताह",
    ts_exceptionHint: "किसी तारीख को बदलने के लिए उस पर टैप करें। बिंदु का अर्थ है वह सामान्य सप्ताह से अलग है।",
    ts_available: "उपलब्ध",
    ...
    ts_pins: "PIN",
    ts_setPin: "PIN सेट करें",
    ts_clearPin: "हटाएं",
    ts_clearPinHint: "PIN हटाएं — फिर कोई भी यह नाम चुन सकता है।",
    ts_pinHint: "PIN किसी और के नाम से घंटे दर्ज करने से रोकता है। यह लॉगिन नहीं है: कोई भी स्टाफ डिवाइस टाइमशीट में लिख सकता है, इसलिए भुगतान से पहले माह की जाँच करें।",
