...
const STR = {
  en: {
    ...
    ts_usualWeekHint: "Tap the days you can normally work. This is only a reminder for yourself — your manager sees a day once you tap it in the calendar below.",
    ts_exceptionHint: "Tap a day to answer for it: ✓ available, – not available. A dashed day is only your usual week — tap it to confirm, or your manager sees no answer for it.",
    ts_hoursSection: "Hours",
    ts_peopleSection: "People",
    ts_viewWeek: "Week",
    ts_viewMonth: "Month",
    ts_freeCount: "Free",
    ts_availLegend: "✓ available · – not available · · not answered. Only days a person answered for themselves are shown; a usual working week is not counted as an answer.",
  ...
  hi: {
    ...
    ts_usualWeekHint: "जिन दिनों आप आमतौर पर काम कर सकते हैं उन्हें चुनें। यह सिर्फ आपकी याद के लिए है — मैनेजर को दिन तभी दिखता है जब आप नीचे कैलेंडर में उस पर टैप करें।",
    ts_exceptionHint: "दिन पर टैप करके जवाब दें: ✓ उपलब्ध, – अनुपलब्ध। बिंदीदार दिन सिर्फ आपका सामान्य सप्ताह है — टैप करके पक्का करें, वरना मैनेजर को उसका कोई जवाब नहीं दिखता।",
    ts_hoursSection: "घंटे",
    ts_peopleSection: "लोग",
    ts_viewWeek: "सप्ताह",
    ts_viewMonth: "महीना",
    ts_freeCount: "उपलब्ध",
    ts_availLegend: "✓ उपलब्ध · – अनुपलब्ध · · कोई जवाब नहीं। सिर्फ वही दिन दिखते हैं जिनका व्यक्ति ने खुद जवाब दिया; सामान्य कार्य-सप्ताह जवाब नहीं माना जाता।",
    ts_available: "उपलब्ध",
